...
export function CTAEbookButton({
  text = (
    <>
      <span className="font-light">Baixe GRATUITAMENTE o nosso ebook</span>
      <br />
      <strong className="font-bold text-xl">
        E-book 5 Prompts de IA para Criar Conteúdo Rápido, Criativo e
        Estratégico
      </strong>
    </>
  ),
  ...
  return (
    <a
      ...
      className={clsx(
        ...
        "font-medium px-1 py-1 rounded hover:opacity-90 transition-all",
        "hover:shadow-2xl hover:shadow-[#776E3C]",
        "cursor-pointer w-full"
      )}
    >
      <span className="bg-white flex items-center gap-4 w-full rounded px-6 py-5 hover:bg-white/80">
